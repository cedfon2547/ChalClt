...
public class PanelHelper {
        ...
        public static List<double[][]> buildWall2(double[] position, Dimension dimension, double epaisseurMur,
        ...
        public static TriangleMesh[] generateMeshMurs(double largeur, double hauteur, double longueur,
                ...
                murFacade = murFacade.translate(murFacadeCenter.multiply(-1));
                murArriere = murArriere.translate(murArriereCenter.multiply(-1));
                murDroite = murDroite.translate(murDroiteCenter.multiply(-1));
                murGauche = murGauche.translate(murGaucheCenter.multiply(-1));
